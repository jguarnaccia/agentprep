-- ============================================================================
-- SPACED REPETITION SYSTEM (SRS) - Database Migration (FIXED)
-- ============================================================================
...
-- FIXED: Handles TEXT question_id to INTEGER id casting
...
-- ============================================================================
-- STEP 6: Create helpful views for SRS analytics (WITH TYPE CASTING)
-- ============================================================================

-- View: Questions due for review (FIXED - handles TEXT question_id)
...
JOIN questions q ON up.question_id::INTEGER = q.id
...
-- View: Flashcards due for review (FIXED - handles UUID flashcard_id)
...
-- View: User SRS statistics (FIXED - removed unnecessary VIEW joins)
...
-- 7. FIXED: Type casting handles TEXT question_id to INTEGER id conversion
-- ============================================================================
