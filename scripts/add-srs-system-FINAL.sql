-- ============================================================================
-- SPACED REPETITION SYSTEM (SRS) - Database Migration (FINAL FIX)
-- ============================================================================
...
-- FIXED: Correct column names for your actual database schema
...
-- View: Questions due for review (with proper type casting)
...
-- View: Flashcards due for review (with correct column names)
...
-- 7. FIXED: Uses correct column names from your actual schema
--    - flashcards.article_reference (not article_number)
--    - user_progress.question_id cast to INTEGER
-- ============================================================================
